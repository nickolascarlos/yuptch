...
var isAlbumALink_1 = __importDefault(require("./isAlbumALink"));
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    ;
                    return [4 /*yield*/, isAlbumALink_1.default($)];
                case 2:
                    _b = _c.sent(), albumIsALink = _b[0], albumHref = _b[1];
                    return [2 /*return*/, new Album_1.default(albumTitle, baseUrl, albumUrl.split('?')[0].split('/').slice(3).join('/') + '/', mainImageId, imagesUrls, albumIsALink, albumHref)];
            }
        });
    });
}

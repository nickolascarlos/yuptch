...
function getAlbum(albumUrl) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var albumHTMLContent, $, baseUrl, albumTitle, mainImageId, imagesUrls;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(albumUrl)];
                case 1:
                    albumHTMLContent = (_b.sent()).data;
                    ...
                    ;
                    return [2 /*return*/, new Album_1.default(albumTitle, baseUrl, albumUrl.split('?')[0].split('/').slice(3).join('/') + '/', mainImageId, imagesUrls)];
            }
        });
    });
}
